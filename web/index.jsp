...
<html>
  ...
  <body>
    ...
    <form action="controllaDati" method="get" >
      ...
      Prezzo: <input id="p1" type="text" name="prezzo" id="priceField" onclick="this.style.textDecoration = 'none';this.style.color = 'black'" <%if (request.getAttribute("errorMessage") != null && ((String)(request.getAttribute("errorMessage"))).charAt(11) == 'i'){out.print("style=\"color: red; text-decoration: line-through\"");}%> value="<%temp = request.getAttribute("pricePlaceholder");if (temp == null){out.println("");} else{out.println(temp);}%>"/>
